...
if __name__ == "__main__":
    ...
    baseFileName = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/TopHiggs/" + flavor + "/BDT_analysis_samples/syst/{sampleName}_{selection}_histo.root"    
    hName = "BDT_Score"
    runDir = "combine_365/run_binned_BDTScore_{flavor}/".format(flavor=flavor)
    ...
    cmd = "cp scripts/ZH_mass_xsec_TopHiggs/combine/datacard_binned_%s.txt %s/" % (flavor, runDir)
