...
def breakDown():
    ...
    #latex.SetTextFont(42)
    #latex.SetTextAlign(30) # 0 special vertical aligment with subscripts
    #latex.DrawLatex(0.95, 0.925, "#sqrt{s} = 365 GeV,  10 ab^{#minus1}")
...
if __name__ == "__main__":
    ...
    if True:
        ...
        combineDir = "combine_365/run_binned_BDTScore_{flavor}/".format(flavor=flavor)
        outDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/TopHiggs/{flavor}/ZH_mass_xsec/combine_binned_BDTScore/".format(flavor=flavor)
        ...
        if flavor == "combine":
           combineCards(combineDir, ["combine_365/run_binned_BDTScore_mumu/datacard_binned_mumu.txt", "combine_365/run_binned_BDTScore_ee/datacard_binned_ee.txt"])
        ...
        if flavor == "mumu":
            ...
            plotMultiple_xsec(["STAT", "STAT", "STAT"], 
                              ...
                              ["/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/TopHiggs/mumu/ZH_mass_xsec/combine_binned_BDTScore/",
                               "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/TopHiggs/ee/ZH_mass_xsec/combine_binned_BDTScore/",
                               "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/TopHiggs/combine/ZH_mass_xsec/combine_binned_BDTScore/"],
                              outDir,
                              name="_STAT")
